...
# Use:
# 'sh newReactComponent.sh <ComponentName>'
#
...
# When you run 'sh newReactComponent.sh <ComponentName>' in your terminal, the script will create a new directory with .JS and .CSS template files in it.
#
# Have fun.
